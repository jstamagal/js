    ...
    return (
        Tool(
            ...
            browser_probe,
            {
                ...
                "settle_ms": {"type": "integer", "minimum": 0, "maximum": 30_000, "default": 1200},
                "hold_ms": {"type": "integer", "minimum": 0, "maximum": 30_000, "default": 1600},
                "viewport_width": {"type": "integer", "minimum": 100, "maximum": 3840, "default": 1280},
                "viewport_height": {"type": "integer", "minimum": 100, "maximum": 2160, "default": 800},
            },
            required=("target",),
        ),
    )
